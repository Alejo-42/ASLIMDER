...
<body>
    ...
    <main>
        <div class="tableRedes">
            <table class="table table-dark">
                ...
                <tr>
                    ...
                    <td>
                        <a href="/editarServicios/{{$Servicios->id}}"><button type="button" class="btn btn-primary">Editar</button></a>
                        <form action="/eliminarServicios/{{$Servicios->id}}" method="post">
                            @csrf
                            @method('delete')
        ...
        <div class="guardarServicios">
            <form action="/guardarServicios" method="post">
                @csrf
